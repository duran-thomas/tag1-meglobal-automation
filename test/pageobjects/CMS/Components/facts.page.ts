...
class FactsBlockPage extends Page {
    ...
    public async createFactsWithHorizontalLayout(mainTitle: string, title1: string, description1: string, title2: string, description2: string, title3: string, description3: string) {
        ...
        await (await this.inputFactDescription1).click();
        await (await this.inputFactDescription1).setValue(description1);
        await (await this.btnAddFact).scrollIntoView();
        await (await this.btnAddFact).click();
        await (await this.inputFactTitle2).waitForExist();
        await (await this.inputFactTitle2).scrollIntoView();
        await (await this.inputFactTitle2).setValue(title2);
        await (await this.inputFactDescription2).setValue(description2);
        await browser.pause(5000);
        await (await this.btnAddFact).waitForClickable();
        await (await this.btnAddFact).scrollIntoView();
        await (await this.btnAddFact).click();
        await (await this.inputFactTitle3).waitForExist();
        await (await this.inputFactTitle3).scrollIntoView();
        await (await this.inputFactTitle3).setValue(title3);
        await (await this.inputFactDescription3).setValue(description3);
        ...
        await (await this.dropdownLayout).selectByIndex(1);
    ...
    public async createFactsWithVerticalLayout(mainTitle: string, title1: string, description1: string, title2: string, description2: string, title3: string, description3: string) {
        ...
        await browser.pause(5000);
        await (await this.dropdownLayout).scrollIntoView();
        await (await this.dropdownLayout).selectByIndex(0);
        await (await this.btnAddBlock).scrollIntoView();
        await (await this.btnAddBlock).click();
        await browser.refresh();
        await (await this.btnSaveLayout).waitForDisplayed();
    ...
    public async createFactsWithGridLayout(mainTitle: string, title1: string, description1: string, title2: string, description2: string, title3: string, description3: string) {
        ...
        await browser.pause(5000);
        await (await this.dropdownLayout).scrollIntoView();
        await (await this.dropdownLayout).selectByIndex(2);
        await (await this.btnAddBlock).scrollIntoView();
        await (await this.btnAddBlock).click();
        await browser.refresh();
        await (await this.btnSaveLayout).waitForDisplayed();
    ...
    public async createFactsWithSliderLayout(mainTitle: string, title1: string, description1: string, title2: string, description2: string, title3: string, description3: string, title4: string, description4: string, title5: string, description5: string) {
        ...
        await (await this.btnAddFact).scrollIntoView();
        await (await this.btnAddFact).click();
        await (await this.inputFactTitle4).waitForExist();
        await (await this.inputFactTitle4).scrollIntoView();
        await (await this.inputFactTitle4).setValue(title4);
        await (await this.inputFactDescription4).setValue(description4);

        await browser.pause(5000);
        await (await this.btnAddFact).waitForClickable();
        await (await this.btnAddFact).scrollIntoView();
        await (await this.btnAddFact).click();
        await (await this.inputFactTitle5).waitForExist();
        await (await this.inputFactTitle5).scrollIntoView();
        await (await this.inputFactTitle5).setValue(title5);
        await (await this.inputFactDescription5).setValue(description5);

        await (await this.dropdownStyling).scrollIntoView();
        await (await this.dropdownStyling).click();
        await browser.pause(5000);
        await (await this.dropdownLayout).scrollIntoView();
        await (await this.dropdownLayout).selectByIndex(3);
        await (await this.btnAddBlock).scrollIntoView();
        await (await this.btnAddBlock).click();
        await browser.refresh();
        await (await this.btnSaveLayout).waitForDisplayed();
